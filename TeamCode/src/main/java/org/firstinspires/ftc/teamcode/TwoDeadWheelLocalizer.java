...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -535.4577999889826; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1399.9607505938548; // x position of the perpendicular encoder (in tick units)
    }
