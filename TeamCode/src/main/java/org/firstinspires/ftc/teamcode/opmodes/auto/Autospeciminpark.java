...
@Autonomous(name = "Auto speciminp park", group = "AAA_COMP", preselectTeleOp="teleop")
public final class Autospeciminpark extends LinearOpMode {
...
//                .build();
        ...
        Action traj2 = robot.db.drive.actionBuilder(constants.zero)
                ...
                .strafeTo(constants.test2.position)
                .build();
